...
$sql = "SELECT * FROM `records` where type=0 ORDER BY udate DESC LIMIT 10";
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid px-5">
    <a class="navbar-brand bg-purple" href="#">Joint HW</a>
    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
      <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="./registeration-login-system/dashboard.php">Dashboard</a>
        </li>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h1 class="uploadHeading story-indicator w-lg-50">Upload your HW</h1>
...
for ($i=0; $i <$rows; $i++) { 
  ...
  $date = $dumpData['date'];
  $subj = $dumpData['subj'];
echo '<div class="card col-10 offset-1 mb-2">
<div class="card-body my-0 py-0 d-flex togggled">
      ...
      <div class="col-lg-5 col-12">
        <ul class="list-group">
          ...
          for($q=0;$q<10;$q++) {
            ...
            echo '<li class="list-group-item"><a href="uploads/'.$who.'/'.$dumpData[$strrr].'" class="link-info-my">'.$dumpData[$strrr].'</a></li>';
